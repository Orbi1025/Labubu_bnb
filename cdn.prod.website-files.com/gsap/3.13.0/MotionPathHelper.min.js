...
!(function (t, e) {
    ...
    for (
      ...
      (i = v),
        ...
        (v === y && b === P) ||
          ...
          (w = P - b),
          (c =
            (((h = U(o * o + r * r)) + (l = U(C * C + w * w))) * e * 0.25) /
            U(Math.pow(C / l + o / h, 2) + Math.pow(w / l + r / h, 2))),
          (p =
            v -
            ((d = v - (v - i) * (h ? c / h : 0)) +
              ((((u = v + (y - v) * (l ? c / l : 0)) - d) *
  ...
  function B(t) {
    ...
    !(x in t.style) &&
      ...
      (E = (x = "msTransform") + "Origin");
    for (; e.parentNode && (e = e.parentNode); );
    if (((g = window), (b = new T()), e)) {
      (f = (p = e).documentElement),
        (_ = e.body),
        ((y = p.createElementNS(
  ...
  function J(t, e) {
    if (t.parentNode && (p || B(t))) {
      var n = H(t),
        ...
        h = p.createElementNS
          ? p.createElementNS(i.replace(/^https/, "http"), s)
          : p.createElement(s);
      return (
        e &&
          (n
    ...
    if ((c.length || c.push(J(t, 1), J(t, 2), J(t, 3)), (n = h ? v : m), h))
      ...
      if (((a = o = 0), S))
        for (
          ...
          4 < (g.getComputedStyle(s)[x] + "").length &&
            ((a = s.offsetLeft), (o = s.offsetTop), (s = 0));
      if (
        "absolute" !== (r = g.getComputedStyle(t)).position &&
        "fixed" !== r.position
      )
  ...
  function getGlobalMatrix(t, e, n, i) {
    if (!t || !t.parentNode || (p || B(t)).documentElement === t)
      return new T();
      ...
      R.addEventListener(
        ...
        function (t) {
          ...
          if ("Shift" === o || 16 === a) L = !0;
            ...
            for (u = !0, e = st.length; -1 < --e; ) st[e]._onPressAlt();
  ...
  function Ma(t) {
    ...
    (this._matrix = this.target.transform.baseVal.getItem(0).matrix),
      ...
      O[t.type]
        ...
        : ((e = null), Ba(R, "mousemove", i._onMove)),
      h || Ba(R, "mouseup", i._onRelease),
      na(t),
      Ja(),
      t.changedTouches
      ...
      if (
        (r
          ? (Ca(r, "touchend", n._onRelease),
            ...
            Ca(R, "touchstart", Fa))
          : Ca(R, "mousemove", n._onMove),
        h ||
          (Ca(R, "mouseup", n._onRelease),
        ...
        return arguments.length
          ? ((this._enabled = t)
              ...
              : ((e = this.isDragging),
                ...
                Ca(R, "mouseup", this._onRelease),
                Ca(R, "mousemove", this._onMove),
  ...
  var ct,
    dt =
      ...
      (ct._deleteSelectedAnchors = function _deleteSelectedAnchors() {
        for (
          var t, e, n, i, s = this._selectedAnchors, a = s.length;
          -1 < --a;
      ...
      (ct.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
        var s,
          ...
          f = -t || c[p - 1] + u;
        for (
          f = f ? 1 / f : -g, g *= 1e3, f *= 1e3, a = nt.length = 0;
          a < p;
          a += 2
        )
          (nt[a] = (((c[a] + d) * g) | 0) / 1e3),
  ...
  function MotionPathHelper(t, e) {
    ...
    t instanceof ut.core.Tween
      ...
      (m._gsHelper = v),
      (ut.utils.toArray(e.container)[0] || _t).appendChild(m),
