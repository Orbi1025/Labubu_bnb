 ...
 *
 * archivo-variable:
 *   - http://typekit.com/eulas/000000000000000077509862
 *   - http://typekit.com/eulas/000000000000000077509861
 * menco:
...
window.Typekit.config = {
  ...
  c: [
    ...
    '"menco",sans-serif',
    ".tk-archivo-variable",
    '"archivo-variable",sans-serif',
  ],
  fi: [42292, 42293, 42296, 42297, 55445, 55446],
  fc: [
    {
      id: 42292,
      family: "menco",
      src: "https://use.typekit.net/af/c0df3e/00000000000000007735b5cd/31/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "300",
        style: "normal",
        stretch: "normal",
    ...
    },
    {
      id: 42293,
      family: "menco",
      src: "https://use.typekit.net/af/ea9a91/00000000000000007735b5cb/31/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "300",
        style: "italic",
        stretch: "normal",
    ...
    },
    {
      id: 42296,
      family: "menco",
      src: "https://use.typekit.net/af/ab282b/00000000000000007735b5d0/31/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "normal",
        stretch: "normal",
    ...
    },
    {
      id: 42297,
      family: "menco",
      src: "https://use.typekit.net/af/367b37/00000000000000007735b5d1/31/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "italic",
        stretch: "normal",
    ...
    },
    {
      ...
      src: "https://use.typekit.net/af/91b001/000000000000000077509862/31/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "100 900",
        style: "italic",
        stretch: "normal",
    ...
    },
    {
      id: 55446,
      family: "archivo-variable",
      src: "https://use.typekit.net/af/489d29/000000000000000077509861/31/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "100 900",
        style: "normal",
        stretch: "normal",
  ...
  fn: ["archivo-variable", ["i6", "n6"], "menco", ["i3", "i7", "n3", "n7"]],
  hn: "use.typekit.net",
  ht: "tk",
  js: "1.21.0",
  kt: "ngn3qpc",
...
/*{"k":"1.21.0","auto_updating":true,"last_published":"2025-10-15 14:13:50 UTC"}*/
